    ...
    def exp(self, hint='+'):  # Calculate exponential of multivector
        ...
        if self_sq.is_scalar():
            ...
            def expand_imag_exp(expr):
                ...
                expr = sympy.simplify(sympy.trigsimp(sympy.expand_trig(sympy.expand_complex(sympy.simplify(expr)))))
                expr = expr.replace(sympy.exp_polar(sympy.I*a), sympy.cos(a)+sympy.I*sympy.sin(a))
                expr = expr.replace(sympy.exp(sympy.I*a), sympy.cos(a)+sympy.I*sympy.sin(a))
                return sympy.simplify(sympy.trigsimp(sympy.expand_trig(sympy.expand_complex(sympy.simplify(expr)))))
            s = simplify(s)
